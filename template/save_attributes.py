...
/***************************************************************************
 ...
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
        ...
        begin                : 2022-05-01
        git sha              : $Format:%H$
        copyright            : (C) 2022 by Alex BAIET
...
class SaveAttributes:
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'Save Attributs as CSV'),
            callback=self.run,
    ...
    def run(self):
        ...
        self.dlg.comboBox.addItems(["jotaro", "joseph", "josephine"])
        ...
        if result:
            ...
            self.iface.messageBar().pushMessage(
                "Success (nothing happened)", "Output file written at " + filename,
