...
# On import les dofférents fichiers python pour avoir accès au différentes fenêtre
from .form1 import DialogBADASSForm1
...
class DialogBADASS:
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.init_fenetre = DialogBADASSForm1(self.iface)


        # show the dialog
        self.init_fenetre.show()
        # Run the dialog event loop

        #Si li bouton correspondant à "Ouvrir une base existante"
        #On appele la méthode ouvrir_base_existante
        self.init_fenetre.pushButton.clicked.connect(self.init_fenetre.ouvrir_base_existante)
        #Si li bouton correspondant à "Créer une nouvelle base"
        #On appele la méthode creer_nouvelle_base
        self.init_fenetre.pushButton_2.clicked.connect(self.init_fenetre.creer_nouvelle_base)

        result = self.init_fenetre.exec_()
