...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'form3_mobilier.ui'))


class DialogBADASSForm3Mobilier(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(DialogBADASSForm3Mobilier, self).__init__(parent)
