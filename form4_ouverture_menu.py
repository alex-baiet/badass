...
#On import les class pour l'intansiation des autres fenetre de niveau 3


# This loads your .ui file so that PyQt can populate your plugin with the elements from Qt Designer
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'form4_ouverture_menu.ui'))


class DialogBADASSForm4OuvertureMenu(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(DialogBADASSForm4OuvertureMenu, self).__init__(parent)
        ...
        #ecouteur d'évenement sur les différents boutons
        """
