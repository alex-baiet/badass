...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'form3_technique.ui'))


class DialogBADASSForm3Technique(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(DialogBADASSForm3Technique, self).__init__(parent)
