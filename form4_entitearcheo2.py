...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'form4_entitearcheo2.ui'))


class DialogBADASSForm4Entitearcheo2(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self,donnees=None, parent=None):
        """Constructor."""
        super(DialogBADASSForm4Entitearcheo2, self).__init__(parent)
        #
