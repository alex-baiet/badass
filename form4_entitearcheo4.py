...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'form4_entitearcheo4.ui'))


class DialogBADASSForm4Entitearcheo4(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self,donnees=None, parent=None):
        """Constructor."""
        super(DialogBADASSForm4Entitearcheo4, self).__init__(parent)
        #
